...
import com.allen.ku.ScreenAdaptiveHelper;
...
//                .load(url)
////                .thumbnail(0.1f).
//                .apply(BaseApplication.getInstance().getRequestOptions())
//                .into((ImageView) view);
//        return this;
//    }
//
//
//    public CodeQuery loadImg(String url, RequestOptions requestOptions) {
//        Glide.with(context)
//                .load(url)
